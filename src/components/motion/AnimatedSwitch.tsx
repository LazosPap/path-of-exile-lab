  ...
  return (
    <SwitchPrimitive.Root
      ...
      className={cn(
        ...
        relative inline-flex shrink-0 items-center rounded-full border border-transparent shadow-xs
      ...
      <SwitchPrimitive.Thumb asChild>
        <motion.span
          ...
          className={cn(
            ...
            dark:data-[state=checked]:bg-primary-foreground pointer-events-none absolute block
            rounded-full ring-0`,
          )}
          animate={{
            width: thumbWidth,
