...
export const CATEGORY_NAMES_STASH = {
  ACCESSORY: "accessory",
  ARMOUR: "armour",
  CARD: "card",
  CURRENCY: "currency",
...
export const CATEGORY_NAMES_EXCHANGE = {
  ATLAS: "atlas",
  CARD: "card",
  CATALYST: "catalysts",
  CURRENCY: "currency",
...
export const SIDEBAR_ITEMS: SidebarSection[] = [
  {
    ...
    categories: [
      {
        name: CATEGORY_NAMES_STASH.CURRENCY,
      ...
      {
        name: CATEGORY_NAMES_STASH.CARD,
      ...
      {
        name: CATEGORY_NAMES_STASH.FRAGMENT,
      ...
      {
        name: CATEGORY_NAMES_STASH.ESSENCE,
      ...
      {
        name: CATEGORY_NAMES_STASH.INCUBATOR,
      ...
      {
        name: CATEGORY_NAMES_STASH.FOSSIL,
      ...
      {
        name: CATEGORY_NAMES_STASH.BEAST,
      ...
      {
        name: CATEGORY_NAMES_STASH.HEIST,
  ...
  },
  {
    ...
    categories: [
      {
        name: CATEGORY_NAMES_STASH.ARMOUR,
      ...
      {
        name: CATEGORY_NAMES_STASH.WEAPON,
      ...
      {
        name: CATEGORY_NAMES_STASH.ACCESSORY,
      ...
      {
        name: CATEGORY_NAMES_STASH.BASES,
      ...
      {
        name: CATEGORY_NAMES_STASH.JEWEL,
      ...
      {
        name: CATEGORY_NAMES_STASH.FLASK,
  ...
  },
  {
    ...
    categories: [
      ...
      {
        name: CATEGORY_NAMES_STASH.UNIQUE_MAP,
      ...
      {
        name: CATEGORY_NAMES_STASH.SCARAB,
      ...
      {
        name: CATEGORY_NAMES_STASH.DELIRIUM_ORB,
      ...
      {
        name: CATEGORY_NAMES_STASH.INVITATION,
